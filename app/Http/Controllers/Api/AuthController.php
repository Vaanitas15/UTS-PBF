...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt(['email' => $request->email, 'password' => $request->password])) {
            ...
            return $this->sendResponse($data, 'Berhasil Guyss');
        }
        return $this->sendError('Password dan Email Tidak Ada.', []);
    }
    ...
    public function register(Request $request)
    {
        ...
        return $this->sendResponse(null, "Berhasil Guysss");
    }
    ...
    public function googleRegisterCallback()
    {
        ...
        if ($existing_user) {
            return $this->sendError("Email Kamu Sudah Terpakai", [], 400);
        }
        ...
        return $this->sendResponse(null, "Daftar Berhasil");
    }
